...
const About: React.FC = () => {
    return (
        ...
        <div className="flex flex-row">
            <VHeader />
            <div className=" w-full bg-gray-50 rounded-lg shadow-lg p-16 mt-1">
                <h1 className="text-4xl font-bold text-blue-600 mb-8">About</h1>
                ...
                <div className="space-y-10">
                    ...
                    <div className="flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-8">
                        <div className="flex justify-center items-center">
                            <Info className="text-blue-600 w-16 h-16 md:w-16 md:h-16" />
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-8">
                        <div className="flex justify-center items-center ">
                            <CheckCircle className="text-green-500 w-16 h-16 md:w-16 md:h-16" />
                        </div>
                        <div className="md:w-2/3">
                    ...
                    <div className="flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-8">
                        <div className="flex justify-center items-center ">
                            <FileText className="text-blue-600 w-16 h-16 md:w-16 md:h-16" />
                        </div>
                        <div className="md:w-2/3">
                    ...
                    <div className="flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-8">
                        <div className="flex justify-center items-center ">
                            <Clock className="text-yellow-500 w-16 h-16 md:w-16 md:h-16" />
                        </div>
                        <div className="md:w-2/3">
                            <h2 className="text-3xl font-semibold text-gray-800 mb-4">Speed and Efficiency</h2>
                            <p className="text-gray-700 text-lg">
